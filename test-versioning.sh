...
echo ""
./docker-dev update help | grep -A 2 "install \[versione\]"
print_success "Help aggiornato con supporto versioni"
echo ""

print_info "Test 2: Comando list"
echo ""
./docker-dev update list 2>&1 | grep -E "Versioni|installare"
...
echo "  • ./docker-dev update install"
echo "  • ./docker-dev update install 2.0.0"
echo "  • ./docker-dev update install v2.0.0"
...
echo ""
echo "Sintassi supportate:"
echo "  • ./docker-dev update changelog"
echo "  • ./docker-dev update changelog 1.5.0"
...
VERSION="1.5.0"
REPO="v-merli/docker-development-environment"
URL="https://github.com/$REPO/releases/download/v${VERSION}/docker-dev-env.tar.gz"
...
echo "  $ ./docker-dev update changelog 2.1.0"
echo "  $ ./docker-dev update install 2.1.0"
echo ""
